...
<div class="md:bg-white container md:mx-4 md:mx-auto md:shadow-lg rounded md:mt-32 flex md:flex-row flex-col md:max-w-2xl lg:max-w-4xl justify-between">
  <div class="md:w-1/2 text-center px-8 py-4 md:block">
    <div class="text-gray-700 font-bold text-4xl md:pt-8">CloudBI Projects</div>
    <p class="text-indigo-500 text-xl"> The SMART Approach to Work & Collaboration for Teams </p>
  ...
  <div class="w-full md:bg-gray-100 md:w-1/2 p-8">
    <form role="form" method="POST" :action="url">
      ...
      <div class="">
        ...
        <p class="py-4">
          <button type="submit" class="bg-blue-700 hover:bg-blue-500 text-white text-xl font-medium py-2 px-4 rounded">Register</button>
        </p>
      </div>
    </form>
  </div>
